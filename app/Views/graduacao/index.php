                ...
                <?php foreach ($data['graduacoes'] as $graduacao) : ?>
                    <tr>
                        <td scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                            <img src="/images/graduacaos/<?= $graduacao['image_path'] ?>" alt="" class="w-20 h-20">
                        </td>
                        <td scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white"><?= $graduacao['nome'] ?> </td>
                        <td class="px-6 py-4"><?= $graduacao['descricao'] ?></td>
