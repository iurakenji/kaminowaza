...
<div class="flex justify-end mx-4 mt-3">
    <button id="checkLocation" type="button" class="text-white bg-blue-500 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">
        Checar Localização
    </button>
</div>
